...
export function RectangleShape({ text, toggleTextInput, image, setImage, emoji, toggleEmojiSelection }) {
  return (
    <div className="relative h-screen w-screen flex items-center justify-center">
      <div id="content-container" style={{ aspectRatio: "1.5" }} className="w-lg relative">
        <div id="image-container" style={{ scale: 0 }} className="h-full w-full rounded-4xl overflow-hidden bg-white">
