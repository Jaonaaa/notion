...
export function RectangleShape({ text, toggleTextInput, image, setImage }) {
  return (
    <div className="relative h-screen w-screen flex items-center justify-center bg-gradient-to-b from-gray-200 to-red-100">
      <div id="content-container" style={{ aspectRatio: "1.5" }} className="w-lg relative">
        <div
          id="image-container"
          style={{ scale: 0 }}
          className="h-full w-full rounded-4xl overflow-hidden bg-white"
        >
          <label
            htmlFor="input-image"
        ...
        <div
          id="emoji-container"
          style={{ scale: 0 }}
          className="absolute w-48 h-48 -top-20 -right-16 p-3 px-3.5"
        >
          <img
