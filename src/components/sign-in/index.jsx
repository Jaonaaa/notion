...
const LoginPage = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen w-screen overflow-hidden">
      ...
      <div className="md:w-[45rem] h-[100vh] p-8 md:p-12 flex flex-col animate-fade-in" style={{ backgroundColor: "#f5f5f3" }}>
        <div className="mb-8">
          <h1 className="text-xl font-medium animate-fade-in-up">Notion</h1>
        </div>

        <div className="flex-grow flex flex-col justify-center max-w-md mx-auto w-full">
          <h2 className="text-xl font-semibold mb-7 animate-fade-in-up stagger-delay-100">Connexion</h2>
        ...
        <div className="mt-auto pt-8 text-left text-xs text-gray-500 animate-fade-in">
          ©{new Date().getFullYear()} Notion. Tous droits réservés.
        </div>
      </div>
